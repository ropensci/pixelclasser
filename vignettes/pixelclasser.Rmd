...
The rule objects store the values passed as parameters, the parameters of the equation of the line (*a* and *c*), and a textual representation of the equation to be evaluated by the classification function. To check the correctness of the rules, the line can be added to the plot:
